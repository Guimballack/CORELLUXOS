    ...
    return (
        <div id="screen-dashboard" className="screen active with-header">
            ...
            <div className="dashboard-menu">
                ...
                {hasAccess('menu_gestao_operacional') && (
                    <button 
                        id="btn-nav-central" 
