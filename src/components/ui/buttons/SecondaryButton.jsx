...
/**
 * SecondaryButton Component (Corellux OS style)
 * Botão secundário de cor de fundo escura com bordas pretas e interações reativas.
 *
 * Props:
...
export default function SecondaryButton({
    ...
    return (
        <button
            ...
            disabled={isDisabled}
            className={`ds-btn ds-btn-secondary ${fullWidth ? 'ds-btn-full' : ''} ${loading ? 'ds-btn-loading' : ''} ${className}`}
            style={style}
            aria-busy={loading}
            {...props}
        >
